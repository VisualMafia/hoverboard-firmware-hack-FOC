...
// Limitation settings
#define I_MOT_MAX       30              // [A] Maximum single motor current limit // CUSTOM CHANGE, DEFAULT: 15
#define I_DC_MAX        32              // [A] Maximum stage2 DC Link current limit for Commutation and Sinusoidal types (This is the final current protection. Above this value, current chopping is applied. To avoid this make sure that I_DC_MAX = I_MOT_MAX + 2A) // CUSTOM CHANGE, DEFAULT: 17
